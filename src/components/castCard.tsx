...
const CastCard = ({
  ...
  return (
    ...
    <div className="p-4 rounded-xl border border-[#382a3d] bg-[#16101e] w-full max-w-xl">
      ...
      {/* time of cast */}
      <p className="text-gray-500 dark:text-gray-400 text-base py-1 my-3">
        {formattedTime}
      </p>
      <div className="text-gray-500 dark:text-gray-400 flex mt-3 ">
        <div className="flex items-center mr-6">
          {/* recasts */}
          <div className="group cursor-pointer flex flex-row items-center justify-center rounded-full p-2 transition-colors hover:bg-gray-200/20 group-hover:bg-gray-200/20 dark:hover:bg-overlay-medium dark:group-hover:bg-overlay-medium text-action-green text-faint">
          ...
          <span className="ml-1">{recastCount}</span>
        </div>
